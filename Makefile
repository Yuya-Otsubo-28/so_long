...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/11/21 17:55:02 by yotsubo           #+#    #+#              #
#    Updated: 2022/11/21 17:56:39 by yotsubo          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = src/draw/draw.c\
	   src/error/error.c\
	   src/event/events_utils.c\
	   src/event/events.c\
	   src/event/player_move.c\
	   src/map/check_goal.c\
	   src/map/check_map_data.c\
	   src/map/get_map_data.c\
	   src/map/map_utils.c\
	   src/map/map.c\
	   src/main.c\
	   src/draw/init_window_image.c\
	   src/error/init_error.c\
	   src/draw/make_image.c
OBJDIR = ./obj
